...
When a room is visited for the first time, it’s SHA-256 hash is calculated and stored in the database alongside the actual room identifier. This hash is used in the URL in place of the real room identifier.
